...
export default function InputCode({error, isShow, setIsShow, value, setValue} : Props) {
    return <div className={classes.container}>
        ...
        <img src={isShow == "password" ? eyeOff : eye}
            alt="eye"
            className={classes.icon}
            onClick={() => { setIsShow(isShow === "password" ? "text" : "password") }} />
    </div>
}