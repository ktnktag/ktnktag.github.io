      ...
      <header className="blog-header">
        <div className="alignment text-center">
          ...
          <h1 className="text-box-lx2">
            Revamping the user experience of a free, open-source educational
            ...
            <div className="column-flex g-40 text-box">
              <span className="column-flex g-20">
                ...
                <p>
                  ...
                  providing coding and development courses to aspiring
                  developers. The project involved a complete UX redesign to
                  improve usability and accessibility without disrupting ongoing
                  learning processes. Given the platform’s open-source nature,
                  the redesign had to prioritize easy-to-develop and maintain
                  solutions.
                </p>
              </span>
              ...
              <span className="column-flex g-20">
                ...
                <ul className="list">
                  <li>
                    ...
                    effective tools for mentor-student interaction. Introducing
                    new widgets and pages was essential to provide clear
                    visibility into progress and feedback, fostering a more
                  ...
                  <li>
                    ...
                    phases to ensure a seamless transition without hindering
                    current learning activities
                  </li>
                  <li>
                    Resource-Constrained Development: As an open-source project,
                    RS School operated with limited development resources. This
                    necessitated the creation of solutions that were
                    straightforward to implement and maintain, ensuring
                    sustainability without compromising user experience
                  </li>
                  <li>
                    ...
                    increasing content accessibility, and enhancing user
              ...
              <span className="column-flex g-20">
                ...
                <ul className="list">
                  <li>
                    ...
                    identify common user pain points and repetitive patterns
                    that hindered the learning experience.
                  </li>
                  <li>
                    Stakeholder Collaboration: Engaged with stakeholders during
                    requirements gathering to align on core objectives, ensuring
                    that the redesign addressed both business goals and user
                    needs.
                  </li>
                  <li>
                    User Research: Conducted comprehensive research, including
                    user interviews, surveys, and field studies, to validate
                    assumptions and prioritize design features.
                  </li>
                  <li>
                    User Flows and CJM: Mapped customer journeys and user flows
                    to visualize key touchpoints and identify areas for
                    improvement.
                  </li>
                  <li>
                    Wireframes and Prototypes: Developed wireframes and
                    interactive prototypes using the Ant-Design system to test
                    design concepts and iterate on feedback before development.
                  </li>
                  <li>
                    Stakeholder Validation: Presented design concepts to
                    stakeholders for feedback, refining the solutions to align
                    with both business and user expectations.
                  </li>
                  <li>
                    User Testing: Conducted usability testing with a sample
                    group to gather insights and fine-tune the design, ensuring
                    alignment with user needs.
                  </li>
                  <li>
                    Development Collaboration: Worked closely with developers,
                    providing detailed task statements and supporting
                    documentation to facilitate smooth implementation and reduce
                    miscommunication.
                  </li>
                </ul>
              </span>
            ...
            <div className="column-grid-mini g-32 text-box">
              <Result name="3 dashboards" isLarge={true}>
                <ul className="list">
                  ...
                  <li>
                    ...
                    performance stats to prevent lost requests and optimize
                    mentor assignments.
                  </li>
                  <li>
              ...
              <Result name="3 New sections">
                <p>
                  ...
                  areas for cross-checks, tests, and mentor reviews,
                  streamlining the assessment workflow and reducing missed tasks
                  by 30%.
                </p>
              </Result>
              <Result name="6 Widgets">
                <p>
                  Student widgets added — enhancing accessibility and quick
                  access to resources, resulting in a 20% boost in student
                  engagement.
                </p>
              </Result>
              <Result name="1 Registration ">
                <p>
                  Unified registration flow for mentors and students —
                  simplifying onboarding and ensuring data accuracy across the
                  platform, reducing form completion errors by 15%.
                </p>
              </Result>
          ...
          <Sliding name="Research and Discovery">
            <div className="column-flex g-20 text-box">
              ...
              <ul className="list">
                ...
                <li>
                  An online survey to gather quantitative data on platform
                  usage, common issues, and feature requests.
                </li>
                <li>
                  Follow-up interviews to gain qualitative insights into
                  specific challenges and workflow inefficiencies.
                </li>
                <li>
                  Data synthesis to identify recurring themes and prioritize
          ...
          <Sliding name="Data Analysis and Problem Definition">
            <div className="column-flex g-20 text-box">
              ...
              <ul className="list">
                ...
                <li>
                  Gaps in the existing mentor-student interaction flow,
                  including lack of visibility into application statuses and
                  feedback loops.
                </li>
                <li>
            ...
            <div className="column-flex g-20 text-box">
              ...
              <ul className="list">
                ...
                <li>
                  ...
                  visualize friction points across the student, mentor, and
                  admin journeys.
                </li>
                <li>
        ...
        <section className="alignment column-flex g-60">
          <Sliding name="Testing and Handoff">
            <div className="column-flex g-20 text-box">
              ...
              <ul className="list">
                <p>
                  To ensure design accuracy and identify areas for improvement,
                  I developed interactive prototypes and conducted targeted
                  testing sessions:
                </p>
                <li>
                ...
                <li>
                  ...
                  outlining implementation requirements, component
                  specifications, and priority levels for each update.
                </li>
                <li>
                  Monitored task progress, provided clarification when needed,
                  and ensured alignment between design intent and final
                  implementation.
                </li>
              </ul>
            </div>
