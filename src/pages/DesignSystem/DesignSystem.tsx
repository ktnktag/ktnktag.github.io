    ...
    return (<>
        <section className="blog-header">
            <div className="alignment">
                <Link to='https://www.sap.com/index.html'>https://www.sap.com/index.html</Link>
                <h1>Design System for the Leading Global Tech Company</h1>
            </div>
            <img src={headerImg} alt="header" />
        </section>

        <section className="alignment blog-marg column-flex g-40">
            <div className="blog">
        ...
        <section className="alignment blog-marg column-flex g-60">
            <div className="blog">
        ...
        <section className="alignment blog-marg column-flex g-60">
            <div className="blog">
                ...
                <div className="column-flex g-20">
                    ...
                    <p>In our pursuit of building a robust design system, we followed a core principle:"Documentation, documentation, documentation.” Our goal was to precisely capture the life cycle of every reusable element used across SAP websites, mobile screens, and large standalone displays.
                        This included thorough documentation of all components and patterns — from breadcrumbs and headers to inputs, buttons, and layouts. Each item was accompanied by detailed specifications covering structure, states, behaviors, responsive behavior, and accessibility considerations.
                        By committing to structured, clear documentation, we ensured smooth collaboration between designers and developers, minimized ambiguity, and created a reliable source of truth for implementation and maintenance across platforms.</p>
                </div>
            </div>
        ...
        <section className="alignment blog-marg column-flex g-60">
            <div className="blog">
                ...
                <div className="column-flex g-20">
                    ...
                    <p>After development, I reviewed each component in Storybook to check that it matched the designs from Figma — both in visuals and behavior. If something didn’t work or look right, I logged it in GitHub and worked with developers to fix it. I retested each component after updates.
                        <br />
                        Once everything worked as expected, I approved the pull request and marked the component as stable — ready for use in production.</p>
                </div>
            </div>
        ...
        <section className="alignment blog-marg">
            <div className="blog">
                <div><p className="eyebrow">Nowadays</p></div>
                <div className="column-flex g-20">
                    <h2>Continuous Development and Iteration</h2>
                    <p>The design system is not a static asset — it continues to evolve and expand. Regular updates are released to address emerging project needs and incorporate user feedback from designers across multiple teams.
                        A structured feedback loop has been established to gather insights on component usability, identify gaps in patterns, and refine interactions. This ongoing analysis enables the team to prioritize necessary adjustments, implement enhancements, and maintain alignment with evolving product requirements.
