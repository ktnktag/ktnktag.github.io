            ...
            <section className="alignment column-flex g-60">
                <Sliding name="Phase 1 – Map">
                    <div className="column-flex g-20 text-box">
                        ...
                        <p>We began by mapping out the challenge — identifying user needs, business goals, and pain points. This step helped the team build a shared understanding of the problem space and align on the objectives for the sprint.</p>
                    </div>
                </Sliding>
            ...
            <section className="alignment column-flex g-60">
                <Sliding name="Phase 2 – Sketch">
                    <div className="column-flex g-20 text-box">
                        ...
                        <p>This phase focused on generating and expanding possible directions before narrowing in on a final concept. We began with <strong>Lightning Demos</strong>, reviewing existing products and interfaces that tackled similar challenges. This helped us surface best practices and gather references that could inform our design decisions — especially around structure, interaction patterns, and data handling.</p>
                        <p>Next, we ran a <strong>Crazy 8s exercise</strong> — a fast-paced sketching activity where each team member created eight distinct ideasin under 8 minutes. This pushed us to explore a wide range of possible solutions, from simple variations to unconventional flows. The intent wasn’t perfection, but volume and variety, encouraging lateral thinking.
                            <br /> After sketching, all ideas were submitted to the moderator for anonymous voting. This ensured that selection wasn’t biased by team roles or personalities, letting the strongest solutions surface on merit alone.</p>
                        <p><i>Personally, this stage was the most creatively demanding — balancing open ideation with the real constraints of SAP Fiori. I had to constantly assess which concepts were feasible within the design system and where limited customization might be justified. It was a valuable push-and-pull between creativity and system compliance.</i></p>
                    </div>
                </Sliding>
            ...
            <section className="alignment column-flex g-60">
                <Sliding name="Phase 3 – Decide">
                    <div className="column-flex g-20 text-box">
                        ...
                        <p>The team reviewed the top-voted ideas and collaboratively decided on a solution direction. Discussions focused on feasibility, alignment with the design system, and whether we were willing to introduce minor customizations to meet user needs.</p>
                    </div>
                </Sliding>
            ...
            <section className="alignment column-flex g-60">
                <Sliding name="Phase 4 – Prototype">
                    <div className="column-flex g-20 text-box">
                        ...
                        <p>I was responsible for building the prototype based on the team's discussions and key decisions. After an in-depth conversation with the Lead Designer and Project Owner, we aligned on our core vision and identified the key features that were essential for testing. At the same time, we prioritized which elements could be postponed due to the limited timeframe of the design sprint.</p>
            ...
            <section className="alignment column-flex g-60">
                <Sliding name="Phase 5 – Test">
                    <div className="column-flex g-20 text-box">
                        ...
                        <ul className="list">
                            <p>To validate our solution, we conducted remote moderated usability testing with internal SAP users.</p>
                            <li>Task-Based Testing: Participants were asked to complete specific tasks that reflected real-world usage scenarios.</li>
                            <li>Moderator-Led Sessions: Moderator guided users, prompting them to think aloud and share reactions in real time.</li>
                            <li>Live Note-Taking: A dedicated observer captured pain points, quotes, and behavioral patterns to inform refinements.</li>
                            <p>This phase helped us bridge the gap between concept and reality, uncovering actionable insights that informed the final iteration of the design.</p>
                        </ul>
                    </div>
                </Sliding>
            ...
            <section className="alignment column-flex g-60">
                <Sliding name="Phase 5 – Test">
                    <div className="column-flex g-20 text-box">
                        ...
                        <p>Once the design sprint was complete, we entered the refinement and implementation phase. I updated the mockups based on usability testing insights, focusing on interaction clarity, simplification, and alignment with the Fiori design system.</p>
                        <p>Instead of creating separate documentation, I embedded all relevant logic, field behavior, and interaction rules directly into the design file using contextual annotations.</p>
                    </div>
                </Sliding>
                ...
                <Sliding name="">
                    <div className="column-flex g-20 text-box">
                        <h2>Validating the Concept Through Real User Feedback</h2>
                        <ul className="list">
                            <p>Given the complexity of the new sections, development was split into multiple sprints. I supported the implementation by:</p>
                            <li>Structuring the design file for easy handoff</li>
                            <li>Answering questions in real time during dev handovers</li>
                            <li>Quickly adjusting layouts and logic based on technical feedback</li>
                            <li>Ensuring consistent visual behavior across use cases and data states</li>
                            <p>This approach kept the process fast, transparent, and closely aligned between design and development—without the need for extra documentation layers.</p>
                        </ul>
                    </div>
                </Sliding>
            </section>
