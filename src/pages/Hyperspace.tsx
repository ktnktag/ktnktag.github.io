          ...
          <div className="column-flex g-40 text-box">
            <div className="column-flex g-20">
              ...
              <p>
                ...
                user-centred, sprint-based design process to introduce entirely
                new functionality — all while maintaining strict alignment with
                SAP Fiori and supporting scalability across internal teams.
              </p>
            </div>
            ...
            <div className="column-flex g-20">
              ...
              <p>
                ...
                SAP's internal CI/CD platform: one related to backlog
                ...
                retire legacy UI and bring the platform into alignment with the
            ...
            <div className="column-flex g-20">
              ...
              <ul className="list">
                ...
                <li>
                  ...
                  throughout refinement and handoff — ensuring that designs were
                  both feasible and well-documented
                </li>
              </ul>
        ...
        <Sliding name="Phase 4 – Prototype">
          <div className="column-flex g-20 text-box">
            ...
            <p>
              ...
              and identified the key features that were essential for testing.
              At the same time, we prioritized which elements could be postponed
              due to the limited timeframe of the design sprint.
            </p>
            <p>
              Once the scope was defined, I created an interactive prototype
              that simulated real user interactions as closely as possible. The
              goal was to provide a realistic experience that would allow us to
              gather meaningful feedback during testing.
            </p>
          </div>
        </Sliding>
