          ...
          <div className="column-flex g-40 text-box">
            <div className="column-flex g-20">
              ...
              <p>
                ...
                enabling data teams to work faster, smarter, and more
                efficiently.
              </p>
              <p>
                ...
                presentations and internal storytelling, the solution evolved
                into a robust product foundation designed to support large-scale
                model orchestration, trace simulation, and performance
                benchmarking — all within a dynamic, scalable environment.
              </p>
            </div>
            ...
            <div className="column-flex g-20">
              ...
              <p>
                ...
                four weeks to deliver an interactive demo showcasing GPU-based
                AI workload orchestration. The initial version needed to
                simulate complex infrastructure behavior in real time while
                remaining visually polished and presentation-ready — a rare
                blend of technical depth and storytelling clarity.
              </p>
              ...
              <ul className="list">
                ...
                <li>
                  ...
                  architectural decisions that would allow for future scaling
                  and flexibility.
                </li>
                <li>
        ...
        <Sliding name="Design & Prototyping">
          <div className="column-flex g-20 text-box">
            ...
            <p>
              ...
              patterns that could support the platform’s long-term growth.
              Designs were grounded in role-based logic, dynamic content
              behavior, and complex infrastructure dependencies.
            </p>

            <p>
              A series of interactive Figma prototypes were created to simulate
              real user interactions. These prototypes helped surface design
              gaps, improve clarity, and minimize ambiguity before development.
              They also allowed for hands-on internal validation — enabling
              faster feedback cycles and early technical alignment. Each
              iteration brought the product closer to a balance between
