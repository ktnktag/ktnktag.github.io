...
export default function SignIn() {
    ...
    return <main className={classes.container}>
        <div>
            ...
            <p className='eyebrow'>Enter passcode to continue. <br /> Contact me if you need access to the project</p>
        </div>

        <form className={classes.form} onSubmit={handleFormSubmit} onReset={() => setPasscode('')}>
            <InputCode 
            error={errorPasscode}
            isShow={isShow}
            setIsShow={setIsShow}
        ...
        <p onClick={() => navigate(-3)} className="return"> <Return />Return to Projects</p>
    </main>
}