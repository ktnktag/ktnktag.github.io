      ...
      <SectionLayout name="About the project">
        <div>
          ...
          <p>
            ...
            focused on designing and delivering two complex new feature sections
            for an internal CI/CD platform used by over 50,000 engineers. These
            features were aimed at improving developer workflows and supporting
            SAP's long-term shift from on-premise to cloud-native engineering.
          </p>
          <p>
            ...
            sprint-based design process to introduce entirely new functionality
            — all while maintaining strict alignment with SAP Fiori and
            supporting scalability across internal teams.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="list">
            ...
            <li>
              The second feature was developed through a design sprint to define
              a new user workflow from scratch — extending the platform's
              capabilities in how teams manage and share project-level data.
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="list">
            <li>
              Early alignment with the Lead Designer and Product Owner to define
              scope, prioritize functionality, and avoid over-customization
            </li>
            <li>
              Component-first thinking, reusing and adapting SAP Fiori elements
              wherever possible to reduce complexity and support consistency
            </li>
            <li>
            ...
            <li>
              ...
              refinement and handoff — ensuring that designs were both feasible
              and well-documented
            </li>
          </ul>
