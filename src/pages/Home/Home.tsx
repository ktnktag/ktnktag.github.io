...
export default function Home() {
    return <>
        ...
        <Banner name='Build It Better: A Step-by-Step Guide to Creating Your First Product' path='/auth/sign-in' img={BannerImg}>This hands-on workbook walks you through every stage of product creation — from shaping your first concept to launching a functional MVP. Rooted in real-world experience, it’s designed to help you build not just faster, but smarter.</Banner>
