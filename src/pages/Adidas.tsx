      ...
      <header className="blog-header">
        <div className="alignment text-center">
          ...
          <h1 className="text-box-lx2">
            Enhancing user experience during adidas' Fiori migration to support
            ...
            <div className="column-flex g-40 text-box">
              <span className="column-flex g-20">
                ...
                <p>
                  ...
                  aimed to migrate and redesign a group of legacy web
                  applications into the SAP Fiori framework. These apps were
                  part of a broader strategic transformation under the “Own the
                  Game” initiative, replacing outdated platforms like SAP GUI
                  and Bizagi with unified, modern, and mobile-adaptable
                  interfaces. <br />
              ...
              <span className="column-flex g-20">
                ...
                <ul className="list">
                  ...
                  <li>
                    ...
                    framework — without over-customization and while preserving
                  ...
                  <li>
                    Designing solutions for highly complex business domains,
                    such as order management, logistics, debt tracking, and
                    factory operations, spanning multiple countries and
                    stakeholder groups.
                  </li>
                  <li>
                    Maintaining clear, ongoing collaboration with a
                    cross-functional team of business analysts, software
                    architects, developers, and QA specialists through daily
                    syncs and iterative feedback loops.
                  </li>
                  <li>
        ...
        <section className="alignment column-flex g-60">
          ...
          <Sliding name="">
            <div className="column-flex g-20 text-box">
              <span>
                <p>
                  Designs were reviewed frequently — often daily — in short
                  syncs with stakeholders, the BA, and developers. We discussed
                  logic, field behavior, and alignment with real business cases.
                </p>
                <p>
